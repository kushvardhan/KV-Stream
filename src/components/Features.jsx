...
const Features = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Our new recommendation engine analyzes your viewing history and preferences to suggest content you'll love. The more you use KV Stream, the better our recommendations become. Discover new movies and shows tailored specifically to your taste, and explore content you might have missed otherwise.",
      icon: "ri-heart-line",
      color: "bg-red-500",
    },
    {
      title: "Watch Parties",
      description:
        "Now you can enjoy movies and TV shows together with friends, no matter where they are. Create a watch party, invite your friends, and stream content in perfect sync. Chat with your friends while watching, react to scenes in real-time, and share the experience as if you were all in the same room.",
      icon: "ri-group-line",
      color: "bg-green-500",
    },
    {
    ...
    },
    {
      ...
      description:
        "Our new subtitle system supports over 50 languages with customizable appearance. Adjust the font size, color, and position to suit your preferences. We've also added support for closed captions and audio descriptions to make content more accessible for everyone.",
      icon: "ri-subtitle",
      color: "bg-yellow-500",
    },
    {
  ...
  return (
    <div className="w-full h-full flex flex-col md:block">
      ...
      <div
        className={`w-full md:w-[80%] lg:w-[82%] xl:w-[85%] h-full overflow-x-hidden overflow-auto pt-14 md:pt-0 transition-all duration-300 md:ml-[20%] lg:ml-[18%] xl:ml-[15%] ${
      ...
      >
        ...
        <div className="p-4 sm:p-6">
          ...
          <p className="text-zinc-300 text-sm sm:text-base md:text-lg mb-8 max-w-3xl">
            We're constantly working to improve your experience on KV Stream.
            Here are some of our latest features and improvements that we've
            added to make your streaming experience even better.
          </p>
            ...
            {features.map((feature, index) => (
              ...
              >
                <div className={`${feature.color} p-4 flex items-center`}>
                  <i
                    className={`${feature.icon} text-2xl sm:text-3xl text-white mr-3`}
                  ></i>
          ...
          <div className="mt-10 mb-8 bg-[#6556CD] rounded-lg p-6 text-white">
            ...
            <p className="text-sm sm:text-base mb-4">
              We're working on even more exciting features that will be
              available soon:
            </p>
