...
const SideNav = ({ onToggle }) => {
  ...
  // All routes should have fixed sidebar
  const isFixedRoute = true;
      ...
      <div
        className={`sidebar-container max-w-[100vw] ${
          isMobile
            ...
            : "w-full md:w-[20%] lg:w-[18%] xl:w-[15%] fixed top-0 left-0 z-[100] h-screen"
        } border-r border-zinc-400 py-8 px-4 overflow-x-hidden ${
          isMobile ? "overflow-y-auto h-full" : "overflow-y-auto"
